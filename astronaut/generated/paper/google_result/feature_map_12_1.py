...
class LEFM_FRXFeatureMap(BaseFeatureMap):
    """LEFM with Final RX layer (LEFM-FRX) class.
    ...
    def __init__(self, n_qubits: int, a_coeffs: np.ndarray = None, c_coeffs: np.ndarray = None) -> None:
        """Initialize the LEFM with Final RX layer feature map class.
