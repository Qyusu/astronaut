...
class LEFM_QPERY_b5FeatureMap(BaseFeatureMap):
    """LEFM with Quadratic Post-Entanglement RY (LEFM-QPERY-b5) class.
    ...
    def feature_map(self, x: np.ndarray) -> None:
        ...
        for layer in range(n_layers):
            ...
            for i in range(self.n_qubits):
                qml.RY(phi=5 * x[layer * 2 * self.n_qubits + self.n_qubits + i] ** 2, wires=i)
