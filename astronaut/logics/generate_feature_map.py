...
from astronaut.logics.generation import GenerateCode, GenerateIdea
from astronaut.logics.reflection import ReflectIdea
from astronaut.logics.scoring import ScoringIdea
from astronaut.logics.summarization import SummaryPaper
from astronaut.prompts import (
...
def load_full_text(
    result: QueryResponse, max_paper_tokens: Optional[int] = None, summarizer: Optional[SummaryPaper] = None
...
def generate_code(
    ...
    n_code_history: Optional[int] = None,
